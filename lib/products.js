...
export const PRODUCTS = [
  ...
  },
  {
    ...
    sizes: [
      {
        id: 'M1', label: 'M1 빨강', chipColor: '#e74c3c', excelSize: 'M1(빨강)',
        avg_monthly: 88.3, monthly: { '2026-03': 56, '2026-04': 111, '2026-05': 75, '2026-06': 90, '2026-07': 100 }, default_stock: 84,
      },
      {
        id: 'M2', label: 'M2 노랑', chipColor: '#e6b800', excelSize: 'M2(노랑)',
        avg_monthly: 83.0, monthly: { '2026-03': 87, '2026-04': 123, '2026-05': 64, '2026-06': 123, '2026-07': 62 }, default_stock: 111,
      },
      {
        id: 'L', label: 'L 주황', chipColor: '#e67e22', excelSize: 'L(주황)',
        avg_monthly: 237.0, monthly: { '2026-03': 326, '2026-04': 318, '2026-05': 279, '2026-06': 249, '2026-07': 183 }, default_stock: 110,
      },
      {
        id: 'XL', label: 'XL 검정', chipColor: '#2c3e50', excelSize: 'XL(검정)',
        avg_monthly: 74.3, monthly: { '2026-03': 100, '2026-04': 167, '2026-05': 94, '2026-06': 68, '2026-07': 61 }, default_stock: 63,
      },
    ],
  },
  {
