...
export const VENDORS = [
  ...
  },
  {
    ...
    color: '#0e7c66',
    type: 'usage',
    // Usage months auto-refresh (당월 제외 최근 3개월). `monthly` below is a seed
    // fallback; upload an Excel 관리대장 to recompute in real time.
    products: [
      {
        id: 'bijet_external', name: '석션(외장형)', color: '#0e7c66',
        sheetIncludes: ['외장형'], sheetExcludes: [],
        monthly: { '2026-04': 1155, '2026-05': 205, '2026-06': 875 },
      },
      {
        id: 'bijet_plus_sterile', name: 'Bijet Plus(멸균)', color: '#1a8f76',
        sheetIncludes: ['멸균'], sheetExcludes: ['비멸균'],
